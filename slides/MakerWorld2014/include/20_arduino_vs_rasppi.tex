...
\frametitle{Code auf https://github.com/mschlenker} 
 \begin{center}
    \includegraphics[width=6cm]{photos/codedhtserver.png}
  \end{center}
\end{frame}
...
\item hier zusätzlich: RTC
\item Gesamtkosten: 5 bis 10 Euro \euro
\item ca. ein Jahr Laufzeit auf 3xAA bei Optimierung \euro
\end{itemize}
\end{frame}
...
\item \emph{Kleine Server} für den Hausgebrauch
\item \emph{Stark genug} um bspw. DVB-T oder Webcam zu streamen
\item \emph{Lautloser} Thin Client für Windows- oder Linux-Server
\end{itemize}
\end{frame}
